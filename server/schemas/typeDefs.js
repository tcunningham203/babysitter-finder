...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    updateBabysitter(profilePic: String, zone: String, jobExp: String, otherExp: String, shortNotice: Boolean, transportation: String, activities: String, pets: Boolean, smoker: Boolean, rates: String): Babysitter
