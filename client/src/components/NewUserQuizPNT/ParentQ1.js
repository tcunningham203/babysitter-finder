...
const ParentQ1 = () => {
  ...
  return (
    <div className="bg-blue-200 min-h-screen flex-col flex items-center ">
      <div className="rounded p-3 sm:text-3xl text-xl text-center sm:w-3/4 lg:w-1/2">
        <form onSubmit={handleNext}>
          ...
          <h2 className={`pb-3 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '8', '--out-index': '1'}}>Babysitters in that area will see your profile.</h2>
    ...
    {selectedRegion && (
      <button id="toggle-button" className={` bg-blue-800 hover:bg-blue-900 text-white font-bold py-3 px-16 rounded-full focus:outline-none focus:shadow-outline animate-mapfade-in-button ${isAnimating ? 'cursor-default disabled:pointer-events-none animate-squish-button ' : ''}`}
