...
const ParentQ2 = () => {
  ...
  const handleNext = (e) => {
    ...
    setIsAnimating(true);
    setTimeout(() => {
      navigate('/signuppq/3'); // Navigate to the next question page
    }, 1000); // Adjust the delay time as needed for the animation
  };

  return (
    <div className="bg-blue-200 min-h-screen flex-col flex items-center justify-center">
    ...
    {/* Render confirm button */}
      ...
      <button  className={` bg-blue-800 hover:bg-blue-900  text-white font-bold py-3 px-16 rounded-full focus:outline-none focus:shadow-outline animate-fade-in-button ${isAnimating ? 'cursor-default disabled:pointer-events-none animate-squish-button ' : ''}`}
