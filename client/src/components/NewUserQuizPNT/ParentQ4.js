...
const ParentQ4 = () => {
    ...
    const handleNext = (e) => {
        ...
        setIsAnimating(true);
        setTimeout(() => {
            navigate('/signuppq/5'); // Navigate to the next question page
            ...
            <span className='animate-in-up rounded p-3 sm:text-3xl text-xl text-center w-11/12 sm:w-3/4 lg:w-1/2'>
                <div className={` ${isAnimating ? 'animate-out-up cursor-default disabled:pointer-events-none  ' : ''}`}
                    ...
                    <form >
                        ...
                        <h2 className="py-10">What kind of activities or games do your kids enjoy doing?</h2>
