    ...
    <div className="bg-rose-100 min-h-screen flex-col flex items-center justify-center">
     ...
     <h2 className={` flex items-center justify-center  animate-fade-in-word  ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '1', '--out-index': '2'}}>
       ...
       <BearIcon/>
          ...
          <button
            type="submit"
            className={`my-8 bg-rose-200 hover:bg-rose-200 active:bg-rose-200  text-black font-bold py-3 px-16 rounded-full focus:outline-none focus:shadow-outline animate-fade-in-button ${isAnimating ? 'cursor-default disabled:pointer-events-none animate-blowup-button bg-rose-200 hover:bg-rose-200 active:bg-rose-200' : ''}`}
