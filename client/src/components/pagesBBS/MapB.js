            ...
            <div className="bg-slate-200 min-h-screen flex-col flex items-center ">
                ...
                <div className="rounded p-3 sm:text-3xl text-xl text-center sm:w-3/4 lg:w-1/2">
                    <form onSubmit={handleNext}>
                        <h2 className={`text-center  my-2 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{ '--word-index': '1', '--out-index': '0' }}>Need more options? Try another area.</h2>
                        <h2 className={`text-center text-lg my-2 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '0' }}>&#40;Change permanently on the profile page.&#41;</h2>
                        ...
                        <div className='flex min-w-full justify-center '>
                            ...
                            <div id="map-container " className='md:w-2/3 w-full'>
                                ...
                                {selectedRegion && (
                                    <button id="toggle-button" className={` bg-slate-500 hover:bg-slate-700 text-white font-bold py-1 w-72 rounded-full focus:outline-none focus:shadow-outline animate-mapfade-in-button ${isAnimating ? 'cursor-default disabled:pointer-events-none animate-squish-button ' : ''}`}
