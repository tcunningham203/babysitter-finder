                            ...
                            <div id="map-container " className='md:w-2/3 w-full z-10'>
                                ...
                                >
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '11', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '9', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '12', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '13', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '9', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '13', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '12', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '2' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '13', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '11', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '9', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '12', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '11', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        className={`map5 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '7', '--out-index': '3' }}
                                    ...
                                    <path
                                        ...
                                        className={`map6 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '5', '--out-index': '2' }}
                                    ...
                                    <path
                                        ...
                                        className={`map1 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '2', '--out-index': '1' }}
                                    ...
                                    <path
                                        ...
                                        className={`map1 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '5', '--out-index': '2' }}
                                        onClick={() => handlePathClick("map1")}
                                        data-map="map1"
                                        clipRule="evenodd"
                                    ></path>
                                    ...
                                    <path
                                        ...
                                        className={`map1 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '7', '--out-index': '2' }}
                                        onClick={() => handlePathClick("map1")}
                                        data-map="map1"
                                        clipRule="evenodd"
                                    ></path>
                                    ...
                                    <path
                                        ...
                                        className={`map2 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '4', '--out-index': '1' }}
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`map7 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        className={`map2 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '6', '--out-index': '3' }}
                                        onClick={() => handlePathClick("map2")}
                                        data-map="map2"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                        ...
                                        className={`map2 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '2' }}
                                        onClick={() => handlePathClick("map2")}
                                        data-map="map2"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                        ...
                                        className={`map3 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '3', '--out-index': '1' }}
                                    ...
                                    <path
                                        ...
                                        className={`map4 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '6', '--out-index': '2' }}
                                    ...
                                    <path
                                        ...
                                        className={`map5 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '4', '--out-index': '3' }}
                                        onClick={() => handlePathClick("map5")}
                                        data-map="map5"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                        ...
                                        className={`map5 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '6', '--out-index': '1' }}
                                        onClick={() => handlePathClick("map5")}
                                        data-map="map5"
                                        clipRule="evenodd"
                                    ></path>
