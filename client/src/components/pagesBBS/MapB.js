        ...
        <div className='bg-slate-200 min-h-screen pt-16 sm:pt-20 md:pt-24  '>
            ...
            <div className="flex-col flex items-center z-10 ">
                ...
                <div
                    ...
                    <h1 className={`lg:text-5xl px-1 md:text-4xl text-3xl text-center font-medium   ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '4' }}>
                        View babysitters in a different part of the city.
                    </h1>  
                        ...
                        <div className='flex min-w-full justify-center z-10'>

                            <div id="map-container " className='md:w-2/3 w-full z-10'>
                                ...
                                >
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '11', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '9', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '12', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '13', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '10', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '9', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '13', '--out-index': '5' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '12', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '2' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '13', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '11', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '9', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '12', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '11', '--out-index': '3' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        className={`map9 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '7', '--out-index': '3' }}
                                        onClick={() => handlePathClick("map9")}
                                        data-map="map9"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        className={` hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '5', '--out-index': '2' }}
                                        onClick={() => handlePathClick("map12")}
                                        data-map="map12"
                                        clipRule="evenodd"
                                    ></path>
                                    ...
                                    <path
                                        ...
                                        className={`map1 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '2', '--out-index': '1' }}
                                    ...
                                    <path
                                        ...
                                        className={`map3 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '5', '--out-index': '2' }}
                                    ...
                                    <path
                                        ...
                                        className={`map2 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '7', '--out-index': '2' }}
                                    ...
                                    <path
                                        ...
                                        className={`map4 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '4', '--out-index': '1' }}
                                    ...
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        className={`mapX animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '4' }}
                                    ></path>
                                    <path
                                        fill="#0E4774"
                                        fillRule="evenodd"
                                    ...
                                    <path
                                        ...
                                        className={`map5 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '6', '--out-index': '3' }}
                                    ...
                                    <path
                                        ...
                                        className={`map6 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '8', '--out-index': '2' }}
                                    ...
                                    <path
                                        ...
                                        className={`map7 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '3', '--out-index': '1' }}
                                        onClick={() => handlePathClick("map7")}
                                        data-map="map7"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                        ...
                                        className={`map0 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '5', '--out-index': '1' }}
                                    ...
                                    <path
                                        ...
                                        className={`map8 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '6', '--out-index': '2' }}
                                        onClick={() => handlePathClick("map8")}
                                        data-map="map8"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                        ...
                                        className={`map11 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '4', '--out-index': '3' }}
                                        onClick={() => handlePathClick("map11")}
                                        data-map="map11"
                                        clipRule="evenodd"
                                    ></path>
                                    <path
                                        ...
                                        className={`map10 hover:fill-cyan-800 animate-mapfade2-in-word ${isAnimating ? 'animate-mapfade-out-words' : ''}`} style={{ '--word-index': '6', '--out-index': '1' }}
                                        onClick={() => handlePathClick("map10")}
                                        data-map="map10"
                                        clipRule="evenodd"
                                    ></path>
                                </svg>
                                ...
                                {selectedRegion && (
                                    <button id="toggle-button" className={` font-cool bg-slate-700 hover:bg-slate-800 text-white font-bold py-1 w-72 rounded-lg focus:outline-none focus:shadow-outline animate-mapfade-in-button ${isAnimating ? 'cursor-default disabled:pointer-events-none animate-squish-button ' : ''}`}
