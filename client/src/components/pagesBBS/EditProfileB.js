...
function EditProfileB() {
    ...
    return (
        <div className="bg-rose-200 min-h-screen">
            ...
            <div className='mx-8 grid 2xl:grid-cols-12 xl:grid-cols-12  lg:grid-cols-12 md:grid-cols-11  grid-cols-12 justify-between'>
                <div
                    className="2xl:col-start-4 2xl:col-span-6 xl:col-start-4 xl:col-span-6 lg:col-start-3 lg:col-span-8 md:col-start-2 md:col-span-9   col-span-12 flex flex-row  rounded-lg align-center bg-white md:my-5 my-2 justify-evenly  items-center">
                    <h1 className="md:my-5 ms-2 md:text-3xl text-lg text-center">
                        Update your brand.
                    </h1>
            ...
            <div className='mx-8 md:mx-3 xl:mx-16 2xl:mx-44'>
                <div className="bg-rose-200  grid grid-cols-12 justify-center gap-4  ">
