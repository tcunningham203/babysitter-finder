    ...
    <div id="map-container ">
        ...
        >
            <path
                ...
                clipRule="evenodd"
                className={`map7 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '11', '--out-index': '5'}}
            ></path>
            <path
                fill="#0E4774"
                fillRule="evenodd"
            ...
            <path
                ...
                className={`map5 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '8', '--out-index': '5'}}
            ...
            <path
                ...
                className={`map6 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '5', '--out-index': '5'}}
            ...
            <path
                ...
                className={`map1 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '2', '--out-index': '6'}}
            ...
            <path
                ...
                className={`map1 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '5', '--out-index': '6'}}
                onClick={() => handlePathClick("map1")}
                data-map="map1"
                clipRule="evenodd"
            ></path>
            ...
            <path
                ...
                className={`map1 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '7', '--out-index': '5'}}
                onClick={() => handlePathClick("map1")}
                data-map="map1"
                clipRule="evenodd"
            ></path>
            ...
            <path
                ...
                className={`map2 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '4', '--out-index': '5'}}
            ...
            <path
                ...
                className={`map2 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '6', '--out-index': '5'}}
                onClick={() => handlePathClick("map2")}
                data-map="map2"
                clipRule="evenodd"
            ></path>
            <path
                ...
                className={`map2 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '8', '--out-index': '5'}}
                onClick={() => handlePathClick("map2")}
                data-map="map2"
                clipRule="evenodd"
            ></path>
            <path
                ...
                className={`map3 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '3', '--out-index': '5'}}
            ...
            <path
                ...
                className={`map0 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '5', '--out-index': '5'}}
            ...
            <path
                ...
                className={`map4 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '6', '--out-index': '5'}}
            ...
            <path
                ...
                className={`map5 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '4', '--out-index': '5'}}
                onClick={() => handlePathClick("map5")}
                data-map="map5"
                clipRule="evenodd"
            ></path>
            <path
                ...
                className={`map5 animate-fade-in-word ${isAnimating ? 'animate-fade-out-words' : ''}`} style={{'--word-index': '6', '--out-index': '5'}}
                onClick={() => handlePathClick("map5")}
                data-map="map5"
                clipRule="evenodd"
            ></path>
      ...
      {selectedRegion && (
        <button id="toggle-button" className={` bg-rose-400 hover:bg-rose-500 text-white font-bold py-3 px-16 rounded-full focus:outline-none focus:shadow-outline animate-fade-in-button ${isAnimating ? 'cursor-default disabled:pointer-events-none animate-blowup-button ' : ''}`}
