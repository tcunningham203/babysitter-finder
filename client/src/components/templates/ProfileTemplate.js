                            ...
                            <div
                                ...
                                <div className="flex flex-row justify-between py-2  mx-2">
                                    <h5
                                        ...
                                        {babysitter.user.firstName} {babysitter.user.lastName.charAt(0)}.
                                    ...
                                    <div className="flex justify-between align-center text-center items-center ">
                                        ...
                                        {userType === "Parent" && (
                                            <button type="button" onClick={() => showToastMessage(index)}className="items-center flex-col rounded-full bg-slate-700 pb-3 pt-3 w-11 leading-normal text-white transition duration-150 ease-in-out hover:bg-slate-800  focus:outline-none focus:ring-0 active:bg-slate-950 ">
                                                <VscMail size={22} />
                                            </button>
                                        )}
                                        {userType === "Babysitter" && (
                                            <button type="button" onClick={() => showToastMessage(index)}className="items-center flex-col rounded-full bg-gray-400 pb-3 pt-3 w-11 leading-normal text-white transition duration-150 ease-in-out hover:bg-gray-500  focus:outline-none focus:ring-0 active:bg-gray-600 ">
                                                <VscMail size={22} />
                                            </button>
                                        )}
                                ...
                                <p className="mx-2 text-lg pb-4 ">
                                    Rate: {babysitter.rates}
                                </p>

                                </div>

                                <Accordion className="p-0 m-0 flex flex-col items-center align-center relative justify-center" collapseAll>
                                    ...
                                    <Accordion.Panel className="" >
                                        ...
                                        <Accordion.Content className="absolute bottom-10 p-2 m-0 bg-white border-solid border-4 border-slate-600">
                                            ...
                                            <div className="flex flex-col items-start ">
                                                ...
                                                <p className=" text-lg  ">Other Experience:
                                                </p>
                                                <p className="    text-neutral-600 text-sm">
                                                    {babysitter.otherExp}
                                                </p>
                                            ...
                                            {toastStates[index] && (
                                                <div className="bg-slate-900 text-white px-6 py-2 rounded-lg">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <button className="text-gray-100 hover:text-white" onClick={() => hideToast(index)}>
                                                            Confirm
                                                        </button>

                                                        <div className="flex items-center text-gray-400 ">
                                                            <Button onClick={() => hideToast(index)} color="primary" size="small">
                                                                Cancel
                                                            </Button>
                                                        </div></div>
                                                </div>
